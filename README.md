...
- Gestion précise des erreurs avec un comportement et un message différent en fonction du code retour d'erreur.  
...
Ce projet a été réalisé mutuellement par @aR7dx et @come-gp